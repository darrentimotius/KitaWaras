...
safety_ans = col2_builder("Bagaimana keamanan di lingkungan tempat tinggal atau tempat kamu beraktivitas?", 2)
basic_needs_ans = col1_builder("Apakah kebutuhan dasarmu (makan, istirahat, keuangan) akhir-akhir ini terasa sulit terpenuhi?", 3)
academic_performance_ans = col2_builder("Bagaimana kemampuan fokus atau konsentrasimu saat mengerjakan tugas kuliah?", 2)
